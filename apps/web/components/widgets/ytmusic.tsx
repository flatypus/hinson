...
export default function Playing(): JSX.Element {
  ...
  if (!currentlyPlaying) {
    return (
      <div className="flex h-[32px] w-full flex-row place-items-center items-center gap-2 overflow-hidden whitespace-nowrap rounded-lg bg-white bg-opacity-80 p-2 text-[12px] shadow-lg">
