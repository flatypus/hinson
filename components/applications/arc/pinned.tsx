...
function WrappedIcon({
  ...
  const className = `grid h-full w-full place-items-center rounded-lg bg-black/5 p-2 hover:bg-black/10`;
...
export default function Pinned() {
  const { setTabs, setSelectedTab, tabs } = useContext(ArcContext);
